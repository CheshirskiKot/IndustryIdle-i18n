export const RU = {
    ...
    MinimumTradingAmount: "Вы не можете совершать сделки на сумму ниже минимальной",
    ...
    Settings: "Настройки",
    SellBuildingDesc: "Продажа здания вернет вам 50% ваших инвестиций и 50% ресурсов будет перевезено в Торговый центр",
    ...
    UnderConstruction: "%{building} строится",
    Left: "Лево",
    Right: "Право",
    Auto: "Автоматически",
    ...
    BuildSearchPlaceholder: "Введите название здания/ресурса для поиска",
    ...
    FreeOilTransport: "Бесплатная перевозка нефти",
    ...
    ExtraPolicyPointsDesc: "Увеличение производства политической еденицы на 50%",
    ...
    BuildingRecycleDesc: "Полный возрат затраченных средств, при продаже здания в течение 1 минуты после постройки",
    ...
    Tutorial4:
        "Перевозка ресурсов требует затрат на топливо. На этой карте вы можете использовать <em>бензин⛽</em> как топливо. Вы имеете <em>нефтеперерабатывающий завод</em> который транспортирует нефть из нефтяной скважины и производит бензин.<br><br>Крошечные движущиеся <em>точки</em> представляют собой перемещение ресурсов в реальном времени. Вы должны оптимизировать расположение своих зданий, чтобы минимизировать расстояние перемещения.<br><br><em>Улучшение</em> ваших зданий увеличит их производительность, но также увеличит их энергопотребление и потребление ресурсов.<br><br>Вы можете изменить тип топлива в Транспортном центре🚦. Помните, что производство топлива должно превышать его потребление, иначе производство остановится, когда закончится топливо.",
    Tutorial5:
    ...
    LeaderboardDesc: "Рейтинг лидеров - это все Индустриальные кредиты, которые вы когда-либо зарабатывали",
    Name: "Имя",
    Rank: "Рейтинг",
    ...
    ResourceTilePercentage: "Бонус плитки",
    MapSquareGrid: "Квадрат",
    MapHexGrid: "Шестигранник",
    Stockholm: "Стокгольм",
    StockholmBonus:
        "<li>Бесплатный ветрогенератор 4 уровня</li><li>Бесплатная нефтяная скважина 4 уровня</li><li>Бесплатный нефтеперерабатывающий завод 2 уровня</li><li>Бумажная фабрика разблокирована</li><li>Лесозаготовки производят 2Х продукции</li>",
    Rotterdam: "Роттердам",
    RotterdamBonus:
    ...
    Oslo: "Осло",
    OsloBonus:
        "<li>Нефтеперерабатывающие заводы имеют мощность 2Х</li><li>Газоперерабатывающие заводы имеют мощность 2Х</li><li>Бензиновые электростанции имеют мощность 2Х</li><li>Сталелитейные заводы используют природный газ вместо угля</li><li>Бесплатная перевозка нефти</li>",
    ...
    Rome: "Рим",
    RomeBonus:
        "<li>Колизей разблокирован</li><li>Колизеи имеют производительность 2Х</li><li>Политический центр 5 уровеня</li><li>Оперные театры имеют мощность 2Х</li><li>Студии звукозаписи также производят культуру</li>",
    Detroit: "Детроит",
    DetroitBonus:
        "<li>Завод двигателей разблокирован</li><li>Заводы двигателей имеют производительность 2Х</li><li>Автомобильные заводы имеют мощность 2Х</li><li>Автомобильные заводы не нуждаются в аккумуляторах</li><li>Железнодорожные заводы имеют мощность 2Х</li>",
    Boston: "Бостон",
    BostonBonus:
    ...
    RefundTradeSuccess: "Эта сделка была компенсирована: %{resource} был возвращен в Ваш Торговый цетр",
    ...
    CancelActiveTradeFirst: "У вас есть активные сделки с игроками, пожалуйста, сначала отмените/подтвердтие их",
    FailedToCheckActiveTrade: "Не удалось проверить активные сделки игроков, пожалуйста, повторите попытку позже",
    PlayerTradePriceNotValid: "Торговая цена должна быть между %{min} и %{max} (2Х цена последнего обновления рынка)",
    ...
    PowerBankPowerLeft: "Остаток енергии",
    ...
    Osaka: "Осака",
    OsakaBonus:
        "<li>Ресурсы имеют тенденцию появляться в кластерах</li><li>Склад обеспечивает на 50% больше экономии топлива</li><li>Уникальное здание: Издательство Манга</li><li>Уникальное здание: Аниме-студия</li><li>Заводы полупроводников имеют производительность 2x</li><li>Фабрики литий-ионных аккумуляторов имеют мощность 2x</li><li>Аккумуляторный завод разблокирован</li><li>Аккумуляторные заводы имеют мощность 2х</li><li>Экономия заряда аккуулятора улучшается на 100%</li><li>Аккумуляторный завод не требуют угля</li><li>100К аккумуляторов со старта</li>",
    HideChatDescV2:
    ...
    PlayerTradeBid: "Предложение",
    PlayerTradeAsk: "Спрос",
    ...
    HongKong: "Гонконг",
    HongKongBonus:
        "<li>Уникальный алгоритм ценообразования на рынке - цены подчиняются нормальному распределению (колоколообразная кривая)</li><li>Обновления рынка и сброс торговых квот происходят в два раза чаще (каждый час)</li><li>Исследования можно разблокировать с помощью продаваемых ресурсов</li><li>Уникальное здание: Кунг-Фу Додзё</li><li>Уникальное здание: Тай-Чи Додзё</li><li>Максимальное допустимое количество активных сделок с игроками увеличено на 50%</li><li>+1 к автопродажам со старта</li><li>Уникальная политика: Международная экспортная торговля</li><li>Уникальная политика: Жемчужина Востока</li><li>Киностудии имеют мощность 2x</li>",
    FreeTransportToTradeCenter: "Международная экспортная торговля",
    FreeTransportToTradeCenterDesc:
        "Перевозка в Торговый центр бесплатная, но тперевозка из Торгового центра на 50% дороже",
    TaiChi10xCulture: "Жемчужина Востока",
    TaiChi10xCultureDesc: "Тай-Чи Додзё производит 2х культуры, перевозка Тай-Чи бесплатна",
    ...
    SteamAutoCloudBackup: "Автоматическое облачное резервное копирование Steam",
    SteamAutoCloudBackupDesc:
        "Игра сохраняется автоматически в Вашем локольном сохранении. Локальное сохранение синхронизируется с облаком Steam каждые 10 минут. Вы можете принудительно синхронизироваться с облаком Steam в любое время.",
    SteamAutoCloudBackupFailed: "Автоматическое облачное резервное копирование Steam не выполнено: %{error}",
    SteamManualBackup: "Принудительная синхронизация с облаком Steam",
    UILoading: "Загрузка...",
